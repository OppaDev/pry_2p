...
@section('content')
    <div class="w-full px-6 py-6 mx-auto text-lg">
        ...
        <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="p-6">
                        <div class="text-center">
                            ...
                            <div class="text-sm text-slate-500 space-y-2">
                                <p><i class="fas fa-calendar-plus mr-2"></i>Creado: {{ $asignatura->created_at->format('d/m/Y H:i') }}</p>
                                <p><i class="fas fa-calendar-edit mr-2"></i>Actualizado: {{ $asignatura->updated_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Asignar usuarios con rol estudiante -->
