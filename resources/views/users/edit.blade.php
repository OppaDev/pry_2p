                                ...
                                <div class="w-full max-w-full px-3 md:w-6/12 md:flex-none">
                                    <div class="mb-4">
                                        ...
                                        @error('password')
                                            <p class="mb-0 text-xs leading-tight text-red-500 mt-2">{{ $message }}</p>
                                        @enderror
                                        <p class="mb-0 text-xs leading-tight text-slate-400 mt-1">Mínimo 8 caracteres. Dejar vacío para no cambiar.</p>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full max-w-full px-3">
                                    <div class="mb-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                                        <h6 class="mb-2 text-sm font-semibold text-slate-700">Información del Usuario</h6>
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-slate-600">
                                            <div>
                                                <span class="font-semibold">Email verificado:</span>
                                                <span class="ml-1 px-2 py-1 rounded {{ $user->email_verified_at ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
