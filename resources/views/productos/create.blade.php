                            ...
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full max-w-full px-3 md:w-6/12 md:flex-none">
                                    <div class="mb-4">
                                        ...
                                        <input type="number" id="cantidad" name="cantidad" value="" min=""
                                            required
                                            class="focus:shadow-soft-primary-outline text-lg leading-6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                            placeholder="0">
                                        @error('cantidad')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="precio" name="precio" value=""
                                                ...
                                                class="focus:shadow-soft-primary-outline text-lg leading-6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding pl-8 pr-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                placeholder="0.00">
                                        </div>
                                        @error('precio')
                                            <p class="mb-0 text-sm leading-tight text-red-500 mt-2">{{ $message }}</p>
